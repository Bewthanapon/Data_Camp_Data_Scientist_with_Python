...
sns.lmplot(x='year', y='age', data=nobel, lowess=True,line_kws={'color' : 'black'} )
...
sns.lmplot(x='year', y='age',col='category', data=nobel, lowess=True,line_kws={'color' : 'black'} )
...
display(nobel.nlargest(1,columns='age'))
